...
dbClient.connect(MONGO_URL, function (err, database) {
...
app.get("/api/company/search/:field/", (req, res) => search(req, res, req.params.field, ""));
app.get("/api/company/search/:field/:text", (req, res) => search(req, res, req.params.field, req.params.text));
